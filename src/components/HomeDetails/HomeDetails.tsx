...
const steps = [
  {
    ...
    description: (
      <>
        Reach out to us online or by phone — we’ll understand your needs and
        guide you on the next steps.
      </>
    ),
    image: "/assets/contact.jpg", // Replace with your actual image path
    alt: "Initial Contact",
  },
  {
    ...
    description: (
      <>
        Securely upload your tax forms and financial records through our
  ...
  },
  {
    ...
    description: (
      <>
        Sit back and relax — our experts prepare, review, and file your taxes
